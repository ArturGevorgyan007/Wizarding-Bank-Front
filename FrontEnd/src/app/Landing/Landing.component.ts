...
export class LandingComponent implements OnInit {
  ...
  async login() {
    ...
    this.authService.loginWithRedirect({ authorizationParams: { redirect_uri: 'https://thankful-dune-043ee561e.3.azurestaticapps.net' }, appState: { target: 'Personallll' } })
  ...
  async businessLogin() {
    ...
    this.authService.loginWithRedirect({ authorizationParams: { redirect_uri: 'https://thankful-dune-043ee561e.3.azurestaticapps.net' }, appState: { target: 'Businesssss' } })
    // this.authService.loginWithRedirect({ authorizationParams: { redirect_uri: 'https://thankful-dune-043ee561e.3.azurestaticapps.net' }})
  }
}
